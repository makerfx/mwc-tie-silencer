// -----
// NButton.h - Library for detecting button clicks, doubleclicks and long
...
public:
  ...
  NButton(int id, int pin, int active, bool pullupActive = true);
...
private:
  ...
  unsigned int _clickTicks = 100; // number of ticks that have to pass by
                                  // before a click is detected.
  unsigned int _pressTicks = 700; // number of ticks that have to pass by
